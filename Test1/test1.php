...
//     $topicquenum = mysqli_real_escape_string($conn, $prilimsInput['topic_que_num']);
//     $topicansid = mysqli_real_escape_string($conn, $prilimsInput['topic_ans_id']);
//     $topicanswer = mysqli_real_escape_string($conn, $prilimsInput['topic_ans_answer']);

//     if(empty(trim($topicquenum))){
//         return error422('Enter the question number');
//     }
//     elseif(empty(trim($topicansid))){
//         return error422('Enter the answer id');
//     }elseif(empty(trim($topicanswer))){
//         return error422('Enter the answer');
//     }else{

//        $query = "INSERT INTO `edu_topic_answers`(`topic_que_num`,`topic_ans_id`,`topic_ans_answer`) VALUES ('$topicquenum','$topicansid','$topicanswer')";
...
//     if (empty(trim($topicquenum))) {
//         return error422('Enter the answer number');
//     } elseif (empty(trim($topicansid))) {
//         return error422('Enter the answer id');
//     } elseif (empty(trim($topicanswer))) {
//         return error422('Enter the answer');
//     } else {
//         $query_answers = "INSERT INTO `edu_topic_answers`(`topic_que_num`,`topic_ans_id`,`topic_ans_answer`) VALUES ('$topicquenum','$topicansid','$topicanswer')";
//         $result_answers = mysqli_query($conn, $query_answers);

        // $tnum = mysqli_real_escape_string($conn, $prilimsInput['t_num']);
        // $modid = mysqli_real_escape_string($conn, $prilimsInput['mod_id']);
        // $topicquestion = mysqli_real_escape_string($conn, $prilimsInput['topic_que_question']);

        // if (empty(trim($topicquenum))) {
        //     return error422('Enter the prelims mcq question number');
        // } elseif (empty(trim($tnum))) {
        //     return error422('Enter the t number');
        // } elseif (empty(trim($modid))) {
        //     return error422('Enter the prelims mcq question');
        // } elseif (empty(trim($topicquestion))) {
        //     return error422('Enter the prelims mcq question id');
        // } else {
        //     $query_questions = "INSERT INTO `edu_topic_questions`(`topic_que_num`,`t_num`,`mod_id`,`topic_que_question`) VALUES ('$topicquenum','$tnum','$modid','$topicquestion')";
        //     $result_questions = mysqli_query($conn, $query_questions);

        //     if ($result_answers && $result_questions) {
        //         $data = [
        //             'status' => 201,
        //             'message' => 'Answer Created Successfully',
        //         ];
